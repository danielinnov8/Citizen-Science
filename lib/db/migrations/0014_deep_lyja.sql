...
ALTER TABLE "challenge_solutions" ADD COLUMN "author_name" text;--> statement-breakpoint
ALTER TABLE "challenge_solutions" ADD COLUMN "author_slug" text;--> statement-breakpoint
...
ALTER TABLE "outreach_sends" ADD CONSTRAINT "outreach_sends_template_id_outreach_templates_id_fk" FOREIGN KEY ("template_id") REFERENCES "public"."outreach_templates"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "challenge_solution_votes" ADD CONSTRAINT "challenge_solution_votes_solution_id_challenge_solutions_id_fk" FOREIGN KEY ("solution_id") REFERENCES "public"."challenge_solutions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
